...
def load_parser():
    ...
    parser.add_argument('--path', type=str, default='vis_double/rgb/jieyin3/')
    parser.add_argument('--out', type=str, default='tmp333/')
    ...
    parser.add_argument('--sub', type=str, nargs='+', default=['tmp1'],
    ...
    parser.add_argument('--body', type=str, default='twohand', choices=['body15', 'body25', 'h36m', 'bodyhand', 'bodyhandface', 'handl', 'handr', 'twohand','total'])#####
    parser.add_argument('--model', type=str, default='manor', choices=['smpl', 'smplh', 'smplx', 'manol', 'manor'])
    ...
    output.add_argument('--vis_smpl', action='store_false')
