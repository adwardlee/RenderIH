...
class PoseArguer:
    ...
    def argue_pose(self, origin_vec_pose, argue_size=10, pose_type='quat', vis=False, random_level=1.0):
        ...
        bend_adjust = self.bend_argue(bend_angles, argue_size, 120 * random_level) #120
        splank_adjust = self.splank_argue(splank_angles, argue_size, 45 * random_level) # 30
    ...
    def bend_argue(self, bend_angles, argue_size, random_angle=45.0):
    ...
    def splank_argue(self, splank_angles, argue_size, random_angle=30.0):
