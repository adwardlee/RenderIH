...
# from common.myhand.model_attn.DualGraph_newlijun import DualGraphnew
from common.myhand.model_attn.DualGraph_nointer import DualGraphnew
...
class decoder(nn.Module):
    def __init__(self,
        ...
        self.dual_gcn = DualGraphnew(verts_in_dim=self.gcn_in_dim,
