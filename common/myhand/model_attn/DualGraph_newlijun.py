...
from .new_cattention import LinearTemporalCrossAttention
from .self_attn import SelfAttn
from .point_transformer import inter_point
...
class DualGraphLayer(nn.Module):
    def __init__(self,
        ...
        self.cross_att = inter_point(verts_out_dim, self.verts_num)#LinearTemporalCrossAttention(verts_out_dim, dropout=dropout)
