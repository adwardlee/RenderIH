...
class InterHand_other():
    def __init__(self, data_path, split):
        ...
        self.black_path = '/mnt/user/E-shenfei.llj-356552/data/dataset/interhand_5fps/interhand_data/train/black_all/'
        self.syns_path = '/mnt/user/E-shenfei.llj-356552/workgroup/lijun/hand_dataset/synthesis/sdf_xinchuan/'
        self.ego3d_annot_path = '/mnt/user/E-shenfei.llj-356552/workgroup/lijun/hand_dataset/ego3dhands/annot/'
        self.ego3d_img_path = '/mnt/user/E-shenfei.llj-356552/workgroup/lijun/hand_dataset/ego3dhands/img/'
        self.h2o3d_img_path = '/mnt/user/E-shenfei.llj-356552/workgroup/lijun/hand_dataset/h2o3d/refine/img/'
        self.h2o3d_annot_path = '/mnt/user/E-shenfei.llj-356552/workgroup/lijun/hand_dataset/h2o3d/refine/anno/'
        self.single_path = '/mnt/user/E-shenfei.llj-356552/data/dataset/interhand_5fps/singlehand/'
        self.syns_img_path = ''
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", type=str, default='/mnt/user/E-shenfei.llj-356552/data/dataset/interhand_5fps/singlehand/')
    ...
    network = load_single_model(opt.cfg)
    ...
    mano_layer = {'left': ManoLayer(mano_path['right'], center_idx=None),
                  'right': ManoLayer(mano_path['right'], center_idx=None)}
    J_regressor = {'left': Jr(mano_layer['right'].J_regressor),
                   'right': Jr(mano_layer['right'].J_regressor)}

    faces_left = mano_layer['right'].get_faces()
    faces_right = mano_layer['right'].get_faces()

    dataset = handDataset(InterHand_other(opt.data_path, split='test'))
    ...
    from utils.eval_metrics import compute_cdev
